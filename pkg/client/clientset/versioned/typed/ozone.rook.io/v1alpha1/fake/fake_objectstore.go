...
var objectstoresResource = schema.GroupVersionResource{Group: "ozone.rook.io", Version: "v1alpha1", Resource: "objectstores"}

var objectstoresKind = schema.GroupVersionKind{Group: "ozone.rook.io", Version: "v1alpha1", Kind: "ObjectStore"}
